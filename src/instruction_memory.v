module Instruction_memory(Address,reset, ReadData);
    ...
    initial begin
        ...
        memory[2] = 32'h06300393;   // ADDI x7, x0, 99: x7 = 99 (for logic operations)
        ...
        memory[9] = 32'h00727433;   // AND x8, x4, x7: x8 = 2 (R-type, 22&99)
        memory[10] = 32'h00726533;  // OR x10, x4, x7: x10 = 119 (R-type, 22|99)
